<div class="flex">
    @if (Auth::check())
        ...
        @elseif ($isDisLiked =  $post->isDisliked())
            <a
            wire:key="isdisliked-{{$post->id}}"
            title="you disliked this"
            class="post
            ">
